...
## 3교시 - 국어
### 바로가기
[국어 바로가기](https://rang.edunet.net/class/G000323851/hmwkppList.do?hmwkSeq=716454&hmwkTypeCd=ALL)
### 문제
1. 인상 깊은 문장을 영어 원문 그대로 옮겨주세요. ('I have a dream' 제외)
2. 교과서에서 해석된 부분을 찾아 우리말 그대로 옮겨주세요.
### 정답
1. [참고 자료]에서 하나 골라서 쓰기.
2. (1)번 답 해석을 교과서에서 찾기 (번역문)
### 참고 자료
```
